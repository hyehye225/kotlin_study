...
// 1) Kotlin 문법 연습 > src/test에 @Test 나 main() 사용
// 2) println 콘솔 > src/test 에 main() 사용
// 3) Android 로그 > src/main Log.d() 사용
// 4) UI 테스트 > androidTest 에 Instrumentation 사용
